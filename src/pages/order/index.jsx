...
class OrderList extends React.Component{
    ...
    render(){
        let tableHeads = ['Order Number', 'Receiver', 'Status', 'Total Price', 'Create Time', 'Operation'];
        return (
            <div id="page-wrapper">
                        ...
                        this.state.list.map((order, index) => {
                            return (
                                <tr key={index}>
                                    ...
                                    <td>
                                        <Link to={ `/order/detail/${order.orderNo}` }><i className="fa fa-eye"></i> View Detail</Link>
                                    </td>
                                </tr>
                            );
                        })
